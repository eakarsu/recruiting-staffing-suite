...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Recruiting Staffing Dashboard"
      subtitle="One merged recruiting staffing view for Candidates, Jobs, Pipelines, Interviews, Scorecards, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared recruiting staffing jobs into one surface. Candidates, Jobs, Pipelines, Interviews, Scorecards, Offers, documents, audit, and AI are presented as platform features.</div>
