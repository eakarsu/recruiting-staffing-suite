...
const entitySeeds = [
  ...
  ["resume-optimizer","Resume Optimizer Records","Resume Optimizer operating queue","Open","Resume Optimizer follow-up list","Resume Job Search","$0"],
  ["application-tracker","Application Tracker Records","Application Tracker operating queue","Review","Application Tracker follow-up list","Resume Job Search","$0"],
  ["interview-prep","Interview Prep Records","Interview Prep operating queue","Review","Interview Prep follow-up list","Resume Job Search","$0"],
  ["career-path-plan","Career Path Plan Records","Career Path Plan operating queue","Review","Career Path Plan follow-up list","Resume Job Search","$0"],
