...
const features = [
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Resume rewrite, role alignment, keyword coverage, achievements, and ATS readiness.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Resume Optimizer", value: "32", note: 'Active items' },
  ...
  },
  {
    ...
    category: "Resume Job Search",
    icon: Workflow,
    summary: "Job applications, status, contacts, follow-ups, and interview pipeline.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Application Tracker", value: "40", note: 'Active items' },
  ...
  },
  {
    ...
    category: "Resume Job Search",
    icon: Workflow,
    summary: "Behavioral questions, coding practice, role-specific prep, and feedback notes.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Interview Prep", value: "48", note: 'Active items' },
      { label: 'Exceptions', value: "5", note: 'Need review' },
      { label: 'Due Soon', value: "8", note: 'Next 14 days' },
    ],
  },
  {
    slug: "career-path-plan",
    title: "Career Path Plan",
    href: "/career-path-plan",
    category: "Resume Job Search",
    icon: Workflow,
    summary: "Skills gap, target roles, learning plan, projects, and milestone tracking.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Career Path Plan", value: "56", note: 'Active items' },
...
export const featureFamilies = [
  ...
  { name: "Resume Job Search", features: ["Resume Optimizer","Application Tracker","Interview Prep","Career Path Plan"] },
