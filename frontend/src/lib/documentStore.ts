...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Candidates Packet', type: 'Candidates', owner: 'Talent Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Jobs Review Bundle', type: 'Jobs', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Pipelines Evidence Set', type: 'Pipelines', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
