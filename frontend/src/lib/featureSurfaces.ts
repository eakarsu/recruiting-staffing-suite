...
const featureSeeds = [
  ['candidates', 'Candidates', 'Candidates operating queue', 'Talent Lead', 'Review and assign next action'],
  ['jobs', 'Jobs', 'Jobs operating queue', 'Talent Lead', 'Review and assign next action'],
  ['pipelines', 'Pipelines', 'Pipelines operating queue', 'Talent Lead', 'Review and assign next action'],
  ['interviews', 'Interviews', 'Interviews operating queue', 'Talent Lead', 'Review and assign next action'],
  ['scorecards', 'Scorecards', 'Scorecards operating queue', 'Operations Lead', 'Review and assign next action'],
  ['offers', 'Offers', 'Offers operating queue', 'Operations Lead', 'Review and assign next action'],
  ['clients', 'Clients', 'Clients operating queue', 'Operations Lead', 'Review and assign next action'],
  ['placements', 'Placements', 'Placements operating queue', 'Operations Lead', 'Review and assign next action'],
  ['background-checks', 'Background Checks', 'Background Checks operating queue', 'Governance Lead', 'Review and assign next action'],
  ['sourcing', 'Sourcing', 'Sourcing operating queue', 'Governance Lead', 'Review and assign next action'],
  ...
  ["candidate-screening","Candidate Screening","Candidate Screening review queue","Recruiter Screener","Review source context and assign owner"],
  ["resume-role-fit","Resume Role Fit","Resume Role Fit review queue","Recruiter Screener","Confirm next action and update evidence"],
  ["interview-shortlist","Interview Shortlist","Interview Shortlist review queue","Recruiter Screener","Confirm next action and update evidence"],
  ["resume-optimizer","Resume Optimizer","Resume Optimizer workspace","Resume Job Search","Review source evidence and assign owner"],
  ["application-tracker","Application Tracker","Application Tracker workspace","Resume Job Search","Confirm findings, next action, and audit evidence"],
  ["interview-prep","Interview Prep","Interview Prep workspace","Resume Job Search","Confirm findings, next action, and audit evidence"],
  ["career-path-plan","Career Path Plan","Career Path Plan workspace","Resume Job Search","Confirm findings, next action, and audit evidence"],
