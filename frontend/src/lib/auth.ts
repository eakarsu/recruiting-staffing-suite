export const AUTH_COOKIE = 'recruiting_staffing_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@recruiting-staffing.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@recruiting-staffing.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@recruiting-staffing.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
