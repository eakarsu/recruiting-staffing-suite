...
PORT="${PORT:-4560}"
DB_NAME="${PGDATABASE:-recruiting_staffing_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Recruiting Staffing Suite"
echo "======================================="
echo
...
echo "Starting recruiting staffing suite frontend on http://localhost:$PORT"
echo "Login: admin@recruiting-staffing.local / admin123"
